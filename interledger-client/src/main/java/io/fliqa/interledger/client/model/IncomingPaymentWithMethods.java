 ...
 */
@JsonPropertyOrder({
  IncomingPaymentWithMethods.JSON_PROPERTY_ID,
  IncomingPaymentWithMethods.JSON_PROPERTY_WALLET_ADDRESS,
  IncomingPaymentWithMethods.JSON_PROPERTY_COMPLETED,
  IncomingPaymentWithMethods.JSON_PROPERTY_INCOMING_AMOUNT,
  IncomingPaymentWithMethods.JSON_PROPERTY_RECEIVED_AMOUNT,
  IncomingPaymentWithMethods.JSON_PROPERTY_EXPIRES_AT,
  IncomingPaymentWithMethods.JSON_PROPERTY_METADATA,
  IncomingPaymentWithMethods.JSON_PROPERTY_CREATED_AT,
  IncomingPaymentWithMethods.JSON_PROPERTY_UPDATED_AT,
  IncomingPaymentWithMethods.JSON_PROPERTY_METHODS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class IncomingPaymentWithMethods {
  ...
  @javax.annotation.Nonnull
  private Set<IlpPaymentMethod> methods = new LinkedHashSet<>();

  public IncomingPaymentWithMethods() { 
  }
  ...
  public IncomingPaymentWithMethods completed(@javax.annotation.Nonnull Boolean completed) {
  ...
  public IncomingPaymentWithMethods incomingAmount(@javax.annotation.Nullable Amount1 incomingAmount) {
  ...
  public IncomingPaymentWithMethods receivedAmount(@javax.annotation.Nonnull Amount1 receivedAmount) {
  ...
  public IncomingPaymentWithMethods expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public IncomingPaymentWithMethods metadata(@javax.annotation.Nullable Object metadata) {
  ...
  public IncomingPaymentWithMethods createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public IncomingPaymentWithMethods updatedAt(@javax.annotation.Nonnull OffsetDateTime updatedAt) {
  ...
  public IncomingPaymentWithMethods methods(@javax.annotation.Nonnull Set<IlpPaymentMethod> methods) {
    this.methods = methods;
    return this;
  }

  public IncomingPaymentWithMethods addMethodsItem(IlpPaymentMethod methodsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public Set<IlpPaymentMethod> getMethods() {
    return methods;
  }
  ...
  @JsonProperty(JSON_PROPERTY_METHODS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMethods(@javax.annotation.Nonnull Set<IlpPaymentMethod> methods) {
    this.methods = methods;
  }


  /**
   * Return true if this incoming-payment-with-methods object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IncomingPaymentWithMethods incomingPaymentWithMethods = (IncomingPaymentWithMethods) o;
    return Objects.equals(this.id, incomingPaymentWithMethods.id) &&
        Objects.equals(this.walletAddress, incomingPaymentWithMethods.walletAddress) &&
        Objects.equals(this.completed, incomingPaymentWithMethods.completed) &&
        Objects.equals(this.incomingAmount, incomingPaymentWithMethods.incomingAmount) &&
        Objects.equals(this.receivedAmount, incomingPaymentWithMethods.receivedAmount) &&
        Objects.equals(this.expiresAt, incomingPaymentWithMethods.expiresAt) &&
        Objects.equals(this.metadata, incomingPaymentWithMethods.metadata) &&
        Objects.equals(this.createdAt, incomingPaymentWithMethods.createdAt) &&
        Objects.equals(this.updatedAt, incomingPaymentWithMethods.updatedAt) &&
        Objects.equals(this.methods, incomingPaymentWithMethods.methods);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, walletAddress, completed, incomingAmount, receivedAmount, expiresAt, metadata, createdAt, updatedAt, methods);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IncomingPaymentWithMethods {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMethods() != null) {
      int i = 0;
      for (IlpPaymentMethod _item : getMethods()) {
        if (_item != null) {
          joiner.add(_item.toUrlQueryString(String.format("%smethods%s%s", prefix, suffix,

 ...
 */
@JsonPropertyOrder({
  CreateQuoteRequestOneOf1.JSON_PROPERTY_WALLET_ADDRESS,
  CreateQuoteRequestOneOf1.JSON_PROPERTY_RECEIVER,
  CreateQuoteRequestOneOf1.JSON_PROPERTY_METHOD,
  CreateQuoteRequestOneOf1.JSON_PROPERTY_RECEIVE_AMOUNT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class CreateQuoteRequestOneOf1 extends HashMap<String, Object> {
  ...
  public CreateQuoteRequestOneOf1() { 
  }

  public CreateQuoteRequestOneOf1 walletAddress(@javax.annotation.Nonnull URI walletAddress) {
  ...
  public CreateQuoteRequestOneOf1 receiver(@javax.annotation.Nonnull URI receiver) {
  ...
  public CreateQuoteRequestOneOf1 method(@javax.annotation.Nonnull PaymentMethod method) {
    this.method = method;
    return this;
  }
  ...
  public CreateQuoteRequestOneOf1 receiveAmount(@javax.annotation.Nonnull Amount receiveAmount) {
  ...
  @JsonProperty(JSON_PROPERTY_RECEIVE_AMOUNT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setReceiveAmount(@javax.annotation.Nonnull Amount receiveAmount) {
    this.receiveAmount = receiveAmount;
  }
   ...
   */
  @JsonAnySetter
  public CreateQuoteRequestOneOf1 putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this create_quote_request_oneOf_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateQuoteRequestOneOf1 createQuoteRequestOneOf1 = (CreateQuoteRequestOneOf1) o;
    return Objects.equals(this.walletAddress, createQuoteRequestOneOf1.walletAddress) &&
        Objects.equals(this.receiver, createQuoteRequestOneOf1.receiver) &&
        Objects.equals(this.method, createQuoteRequestOneOf1.method) &&
        Objects.equals(this.receiveAmount, createQuoteRequestOneOf1.receiveAmount)&&
        Objects.equals(this.additionalProperties, createQuoteRequestOneOf1.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(walletAddress, receiver, method, receiveAmount, super.hashCode(), additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateQuoteRequestOneOf1 {\n");

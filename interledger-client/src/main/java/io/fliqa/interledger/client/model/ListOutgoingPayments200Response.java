...
/**
 * ListOutgoingPayments200Response
 */
@JsonPropertyOrder({
  ListOutgoingPayments200Response.JSON_PROPERTY_PAGINATION,
  ListOutgoingPayments200Response.JSON_PROPERTY_RESULT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class ListOutgoingPayments200Response {
  ...
  @javax.annotation.Nullable
  private List<OutgoingPayment> result = new ArrayList<>();

  public ListOutgoingPayments200Response() { 
  }

  public ListOutgoingPayments200Response pagination(@javax.annotation.Nullable PageInfo pagination) {
  ...
  public ListOutgoingPayments200Response result(@javax.annotation.Nullable List<OutgoingPayment> result) {
    this.result = result;
    return this;
  }

  public ListOutgoingPayments200Response addResultItem(OutgoingPayment resultItem) {
    if (this.result == null) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<OutgoingPayment> getResult() {
    return result;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResult(@javax.annotation.Nullable List<OutgoingPayment> result) {
    this.result = result;
  }


  /**
   * Return true if this list_outgoing_payments_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListOutgoingPayments200Response listOutgoingPayments200Response = (ListOutgoingPayments200Response) o;
    return Objects.equals(this.pagination, listOutgoingPayments200Response.pagination) &&
        Objects.equals(this.result, listOutgoingPayments200Response.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListOutgoingPayments200Response {\n");

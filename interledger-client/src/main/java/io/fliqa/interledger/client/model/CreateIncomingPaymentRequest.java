 ...
 */
@JsonPropertyOrder({
  CreateIncomingPaymentRequest.JSON_PROPERTY_WALLET_ADDRESS,
  CreateIncomingPaymentRequest.JSON_PROPERTY_INCOMING_AMOUNT,
  CreateIncomingPaymentRequest.JSON_PROPERTY_EXPIRES_AT,
  CreateIncomingPaymentRequest.JSON_PROPERTY_METADATA
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class CreateIncomingPaymentRequest extends HashMap<String, Object> {
  ...
  public CreateIncomingPaymentRequest() { 
  }

  public CreateIncomingPaymentRequest walletAddress(@javax.annotation.Nonnull URI walletAddress) {
  ...
  public CreateIncomingPaymentRequest incomingAmount(@javax.annotation.Nullable Amount incomingAmount) {
  ...
  @JsonProperty(JSON_PROPERTY_INCOMING_AMOUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIncomingAmount(@javax.annotation.Nullable Amount incomingAmount) {
    this.incomingAmount = incomingAmount;
  }


  public CreateIncomingPaymentRequest expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public CreateIncomingPaymentRequest metadata(@javax.annotation.Nullable Object metadata) {
   ...
   */
  @JsonAnySetter
  public CreateIncomingPaymentRequest putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this create_incoming_payment_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateIncomingPaymentRequest createIncomingPaymentRequest = (CreateIncomingPaymentRequest) o;
    return Objects.equals(this.walletAddress, createIncomingPaymentRequest.walletAddress) &&
        Objects.equals(this.incomingAmount, createIncomingPaymentRequest.incomingAmount) &&
        Objects.equals(this.expiresAt, createIncomingPaymentRequest.expiresAt) &&
        Objects.equals(this.metadata, createIncomingPaymentRequest.metadata)&&
        Objects.equals(this.additionalProperties, createIncomingPaymentRequest.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(walletAddress, incomingAmount, expiresAt, metadata, super.hashCode(), additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateIncomingPaymentRequest {\n");

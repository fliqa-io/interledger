 ...
 */
@JsonPropertyOrder({
  OutgoingPayment.JSON_PROPERTY_ID,
  OutgoingPayment.JSON_PROPERTY_WALLET_ADDRESS,
  OutgoingPayment.JSON_PROPERTY_QUOTE_ID,
  OutgoingPayment.JSON_PROPERTY_FAILED,
  OutgoingPayment.JSON_PROPERTY_RECEIVER,
  OutgoingPayment.JSON_PROPERTY_RECEIVE_AMOUNT,
  OutgoingPayment.JSON_PROPERTY_DEBIT_AMOUNT,
  OutgoingPayment.JSON_PROPERTY_SENT_AMOUNT,
  OutgoingPayment.JSON_PROPERTY_METADATA,
  OutgoingPayment.JSON_PROPERTY_CREATED_AT,
  OutgoingPayment.JSON_PROPERTY_UPDATED_AT
})
...
public class OutgoingPayment {
  ...
  public OutgoingPayment failed(@javax.annotation.Nullable Boolean failed) {
    this.failed = failed;
    return this;
  }
  ...
  public OutgoingPayment receiver(@javax.annotation.Nonnull URI receiver) {
  ...
  public OutgoingPayment receiveAmount(@javax.annotation.Nonnull Amount1 receiveAmount) {
  ...
  public OutgoingPayment debitAmount(@javax.annotation.Nonnull Amount1 debitAmount) {
  ...
  public OutgoingPayment sentAmount(@javax.annotation.Nonnull Amount1 sentAmount) {
  ...
  public OutgoingPayment metadata(@javax.annotation.Nullable Object metadata) {
  ...
  public OutgoingPayment createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public OutgoingPayment updatedAt(@javax.annotation.Nonnull OffsetDateTime updatedAt) {
  ...
  /**
   * Return true if this outgoing-payment object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OutgoingPayment outgoingPayment = (OutgoingPayment) o;
    return Objects.equals(this.id, outgoingPayment.id) &&
        Objects.equals(this.walletAddress, outgoingPayment.walletAddress) &&
        Objects.equals(this.quoteId, outgoingPayment.quoteId) &&
        Objects.equals(this.failed, outgoingPayment.failed) &&
        Objects.equals(this.receiver, outgoingPayment.receiver) &&
        Objects.equals(this.receiveAmount, outgoingPayment.receiveAmount) &&
        Objects.equals(this.debitAmount, outgoingPayment.debitAmount) &&
        Objects.equals(this.sentAmount, outgoingPayment.sentAmount) &&
        Objects.equals(this.metadata, outgoingPayment.metadata) &&
        Objects.equals(this.createdAt, outgoingPayment.createdAt) &&
        Objects.equals(this.updatedAt, outgoingPayment.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, walletAddress, quoteId, failed, receiver, receiveAmount, debitAmount, sentAmount, metadata, createdAt, updatedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OutgoingPayment {\n");

 ...
 */
@JsonPropertyOrder({
  AccessIncoming.JSON_PROPERTY_TYPE,
  AccessIncoming.JSON_PROPERTY_ACTIONS,
  AccessIncoming.JSON_PROPERTY_IDENTIFIER
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class AccessIncoming {
  /**
   * The type of resource request as a string.  This field defines which other fields are allowed in the request object.
   */
  public enum TypeEnum {
    INCOMING_PAYMENT(String.valueOf("incoming-payment"));
  ...
  public AccessIncoming() { 
  }

  public AccessIncoming type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AccessIncoming actions(@javax.annotation.Nonnull Set<ActionsEnum> actions) {
    this.actions = actions;
    return this;
  }

  public AccessIncoming addActionsItem(ActionsEnum actionsItem) {
  ...
  public AccessIncoming identifier(@javax.annotation.Nullable URI identifier) {
  ...
  @JsonProperty(JSON_PROPERTY_IDENTIFIER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIdentifier(@javax.annotation.Nullable URI identifier) {
    this.identifier = identifier;
  }


  /**
   * Return true if this access-incoming object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AccessIncoming accessIncoming = (AccessIncoming) o;
    return Objects.equals(this.type, accessIncoming.type) &&
        Objects.equals(this.actions, accessIncoming.actions) &&
        Objects.equals(this.identifier, accessIncoming.identifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccessIncoming {\n");

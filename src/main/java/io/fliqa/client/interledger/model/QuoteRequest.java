...
public class QuoteRequest {
    ...
    public static QuoteRequest build(URI walletAddress, String receiver, String method) {
        ...
        Assert.notNull(walletAddress, "walletAddress cannot be null.");
        Assert.notNullOrEmpty(receiver, "receiver cannot be null or empty.");
        Assert.notNullOrEmpty(method, "method cannot be null or empty.");
